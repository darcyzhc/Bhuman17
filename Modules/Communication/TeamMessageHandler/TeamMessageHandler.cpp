...
//equal to : Module<TeamMessageHandler, TeamMessageHandlerBase> theTeamMessageHandlerModule("TeamMessageHandler", ModuleBase::communication);



void TeamMessageHandler::update(BHumanMessageOutputGenerator& outputGenerator)
{
  //OUTPUT_TEXT("TeamMessageHandler_TeamMessageHandler::update()1");
  ...
  //OUTPUT_TEXT("TeamMessageHandler_TeamMessageHandler::update()2");
  //OUTPUT_TEXT(outputGenerator.sendThisFrame);
...
void TeamMessageHandler::update(TeamData& teamData)
{
      ...
      {
            //OUTPUT_TEXT("TeamMessageHandler_teamData.generate ");
            if(readSPLStandardMessage(m))
            {
                //OUTPUT_TEXT("TeamMessageHandler_readSPLStandardMessage(m)");
            ...
            {
                //OUTPUT_TEXT("TeamMessageHandler_receivedMessageContainer.lastErrorCode");
                return;
            }
            ...
            {
                //OUTPUT_TEXT("TeamMessageHandler_theFrameInfo.getTimeSince");
